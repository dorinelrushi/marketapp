...
import PayPalOneTimeButton from "@/components/paypal/PayPalOneTimeButton"; // Using the component we have
...
export default function BookingForm({ propertyId, pricePerNight, propertyTitle }: BookingFormProps) {
    ...
    if (step === "loading") {
        return <div className="p-8 text-center"><div className="animate-spin rounded-full h-8 w-8 border-b-2 border-black mx-auto"></div><p className="mt-4 text-zinc-500">Lade Benutzerdaten...</p></div>;
    }
    ...
    if (step === "success") {
        return (
            <div className="text-center p-6 md:p-8 bg-zinc-50 rounded-[32px] border border-zinc-100">
                ...
                <p className="text-zinc-500 mb-8 leading-relaxed text-sm font-medium">Ihre Buchungsanfrage für {propertyTitle} wurde erfolgreich gesendet.</p>
                <button
            ...
            {step === "details" && (
                <form onSubmit={handleContinue} className="space-y-5">
                    <div className="space-y-4">
                        <div className="group">
                            <label className="block text-[9px] font-black text-zinc-300 uppercase tracking-widest mb-1.5 ml-1 group-focus-within:text-black transition-colors">Vollständiger Name</label>
                            <input
                                required
                                name="fullName"
                                type="text"
                        ...
                        <div className="group">
                            <label className="block text-[9px] font-black text-zinc-300 uppercase tracking-widest mb-1.5 ml-1 group-focus-within:text-black transition-colors">E-Mail-Adresse</label>
                            <input
                                required
                                name="email"
                                type="email"
                        ...
                        <div className="group">
                            <label className="block text-[9px] font-black text-zinc-300 uppercase tracking-widest mb-1.5 ml-1 group-focus-within:text-black transition-colors">Telefonnummer</label>
                            <input
                                required
                                name="phone"
                                type="tel"
                    ...
                    {!user && (
                        <p className="text-center text-[10px] font-black text-zinc-300 uppercase tracking-[0.2em] pt-2">
            ...
            {step === "payment" && (
                <div className="space-y-8">
                    <div className="p-6 md:p-8 rounded-[32px] bg-black text-white relative overflow-hidden">
                        ...
                        <div className="relative z-10 flex justify-between items-center mb-6">
                            <div>
                                ...
                                <p className="text-zinc-400 text-[10px] mt-1 font-black uppercase tracking-widest">Einmalige Aktivierung</p>
                            </div>
                    ...
                    <button
                        ...
                        className="w-full text-zinc-300 text-[9px] font-black uppercase tracking-widest hover:text-black transition-colors flex items-center justify-center gap-2"
                    >
                    ...
                    <div className="bg-zinc-50 p-6 md:p-8 rounded-[32px] border border-zinc-100">
                        ...
                        <div className="space-y-4">
                            <div className="flex justify-between items-center py-3 border-b border-zinc-200/50">
                                <span className="text-[9px] font-black text-zinc-300 uppercase tracking-widest">Objekt</span>
                                <span className="text-xs font-black text-black truncate ml-4 max-w-[150px]">{propertyTitle}</span>
                            </div>
                            <div className="flex justify-between items-center py-3 border-b border-zinc-200/50">
                                <span className="text-[9px] font-black text-zinc-300 uppercase tracking-widest">Name</span>
                                <span className="text-xs font-black text-black">{formData.fullName}</span>
                            </div>
                            <div className="flex justify-between items-center py-3 border-b border-zinc-200/50">
                                <span className="text-[9px] font-black text-zinc-300 uppercase tracking-widest">Email</span>
                                <span className="text-xs font-black text-black">{formData.email}</span>
                            </div>
                            <div className="flex justify-between items-center py-3">
                                <span className="text-[9px] font-black text-zinc-300 uppercase tracking-widest">Status</span>
