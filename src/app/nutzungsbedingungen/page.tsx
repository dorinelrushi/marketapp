...
export default function Nutzungsbedingungen() {
    return (
        <div className="max-w-4xl mx-auto px-6 py-16 lg:py-24">
            <h1 className="text-3xl md:text-4xl font-black text-black mb-4 uppercase tracking-tighter font-display">
                NUTZUNGSBEDINGUNGEN
            </h1>
            <h2 className="text-xl md:text-2xl font-black text-black mb-8 uppercase tracking-tight">
            ...
            <div className="bg-zinc-50 border border-zinc-100 rounded-[32px] p-8 md:p-12 mb-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-white p-8 rounded-2xl border border-zinc-100 shadow-sm">
                        <span className="block text-[10px] font-black text-zinc-300 uppercase tracking-widest mb-3">Anfängliche Zahlung</span>
                        <span className="text-2xl font-black text-black uppercase tracking-tighter">0,99 € bei Registrierung</span>
                    </div>
                    <div className="bg-white p-8 rounded-2xl border border-zinc-100 shadow-sm">
                        <span className="block text-[10px] font-black text-zinc-300 uppercase tracking-widest mb-3">Automatische Abrechnung</span>
                        <span className="text-2xl font-black text-black uppercase tracking-tighter">49,99 € nach 24 Stunden</span>
                    </div>
                </div>
            </div>

            <div className="space-y-16 text-zinc-500 leading-relaxed font-medium">
                <section>
                    <h3 className="text-xl font-black text-black mb-6 flex items-center gap-4 uppercase tracking-tight">
